...
-(void)imageProcess:(UIImage *)image{
    ...
    if (data != NULL)
    {
        ...
        CGFloat E535_S,E435_S,E405_S,Mn7_S,Mn6_S,Mn2_S,E535_CS,E435_CS,E405_CS,Mn7_CS,Mn6_CS,Mn2_CS,II,T,RSF,mgl_CH2O,ug_cm2,Mn7R,ERR,maxmgl,maxug,RSFGO;
        II=4.07;
        T=8.53;
        // Diamter Berechnung
        ...
        E535_S = ((-log10(((ssred/(II-4.0)*((T-4.0)*100.0/16.0*(-0.3327)+107.64)/100.0))/3205.0))*112.0+(-log10(((ssgreen/(II-4.0)*((T-4.0)*100.0/16.0*(-0.3327)+107.64)/100.0))/3205.0))*411.0)/100.0;
        E435_S = ((-log10(((ssred/(II-4)*((T-4)*100.0/16.0*(-0.3327)+107.64)/100))/3205))*35+(-log10(((ssblue/(II-4)*((T-4)*100/16*(-0.3327)+107.64)/100))/3205))*306)/100;
        E405_S = ((-log10(((ssred/(II-4)*((T-4)*100/16*(-0.3327)+107.64)/100))/3205))*130+(-log10(((ssblue/(II-4)*((T-4)*100/16*(-0.3327)+107.64)/100))/3205))*200)/100;
        ...
        E535_CS = ((-log10(((bbred/(II-4)*((T-4)*100/16*(-0.3327)+107.64)/100))/3205))*112+(-log10(((bbgreen/(II-4)*((T-4)*100/16*(-0.3327)+107.64)/100))/3205))*411)/100;
        E435_CS = ((-log10(((bbred/(II-4)*((T-4)*100/16*(-0.3327)+107.64)/100))/3205))*35+(-log10(((bbblue/(II-4)*((T-4)*100/16*(-0.3327)+107.64)/100))/3205))*306)/100;
        E405_CS = ((-log10(((bbred/(II-4)*((T-4)*100/16*(-0.3327)+107.64)/100))/3205))*130+(-log10(((bbblue/(II-4)*((T-4)*100/16*(-0.3327)+107.64)/100))/3205))*200)/100;
